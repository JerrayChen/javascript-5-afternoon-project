...
/*
  ...
  However, because each call to console.log occurs 
  after the loop has finished, the value of i has changed before the console.log executes.
...
function timeOutCounter() {
  ...
  for (var i = 0; i <= 5; i++) {
    setTimeout(countingTime, i * 1000);
  }
}
timeOutCounter();
