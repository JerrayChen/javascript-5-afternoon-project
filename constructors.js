...
Movie.prototype.changeRating = function(newRating){
  avgRating = (this.rating+newRating)/2;
...
// that will take in one number parameter representing the post id. 
...
User.prototype.changePostRating = function(id, newRating){
  this.savedPosts = this.savedPosts.map(e=>(e.id === id)?{...e, rating: newRating}:e);
}